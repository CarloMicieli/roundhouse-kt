...
class BrandIdTest {
    ...
    fun `should compare two Brand ids`() {
        val id1 = io.github.carlomicieli.roundhouse.catalog.brands.BrandId.of("brand-id1")
        val id2 = io.github.carlomicieli.roundhouse.catalog.brands.BrandId.of("brand-id2")
    ...
    fun `should produce a String representation for Brand ids`() {
        val id = io.github.carlomicieli.roundhouse.catalog.brands.BrandId.of("brand-id1")
